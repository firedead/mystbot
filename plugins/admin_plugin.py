...
register_command_handler(handler_admin_join, '!join', 100, 'Joins specified groupchat.', '!join <groupchat> [nick]', ['!join jabber@conference.jabber.org', '!join jdev@conference.jabber.org mystbot2'])
...
register_command_handler(handler_admin_uptime, '!uptime', 100, 'Returns Mystbot uptime.', '!uptime', ['!uptime'])
register_command_handler(handler_admin_rooms, '!rooms', 100, 'Returns Mystbot\'s rooms.', '!rooms', ['!rooms'])
